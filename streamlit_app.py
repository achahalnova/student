...
tab1, tab2 = st.tabs(["Results Analyzer (Excel)", "Exam Grader (.dat)"])
        ...
        try:
            ...
            def get_tertiles_marks(local_series, global_series):
                ...
                try:
                    ...
                    # For MARKS, higher value is better
            ...
            # Get Top 500 students based on Total Marks (TM)
